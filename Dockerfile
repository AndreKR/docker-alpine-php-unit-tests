...
RUN apk update
RUN apk upgrade
RUN apk add nodejs-lts openssh-client git php5-cli mysql-client postgresql-client mc php5-pgsql php5-curl bash php5-phar php5-json php5-openssl php5-dom php5-ctype php5-xmlreader php5-mysqli php5-zip
